# Writer packet — `93-interview-build-it.md`
...
```
/Users/rajat.chikkodikar/Desktop/My-files/rough/src/notes/detailed/04-modern-java/93-interview-build-it.md
```
...
| Field | Value |
|---|---|
| File | `93-interview-build-it.md` |
| Subject | 93 interview build it.md |
| Part / tier | Part 4 — INTERVIEW |
| Syllabus sections | §4.1, §4.8 — A functional toolkit from scratch, Diagnostic harnesses |
| Leaves | — (0 leaves) |
| Primary concepts | Part 4 wrap-up: the summary table over every build, 10 spoken-length Q&As, 5 predict-the-output puzzles |
| Diagrams | — |
| Examples (QuizStakes slice) | Puzzles drawn from `MyStream`, `MyOptional` and the concurrency builds |
| Previous | `92-interview-internals.md` |
| Next | `94-interview-questions-a.md` |
