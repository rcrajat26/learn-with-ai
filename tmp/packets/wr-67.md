# Writer packet — `94-interview-questions-b.md`
...
```
/Users/rajat.chikkodikar/Desktop/My-files/rough/src/notes/detailed/04-modern-java/94-interview-questions-b.md
```
...
| Field | Value |
|---|---|
| File | `94-interview-questions-b.md` |
| Subject | 94 interview questions b.md |
| Part / tier | Part 5 — INTERVIEW |
| Syllabus sections | §5.1 — The questions, with the answer shape |
| Leaves | 5.1.33–5.1.64 (32 leaves) |
| Primary concepts | questions 5.1.33–5.1.64 with the full answer shape: reduction, parallel streams, spliterators, `Optional`, `var`, records |
| Diagrams | — |
| Examples (QuizStakes slice) | Every answer grounded in the collector, parallel-stream and record examples the earlier files built |
| Previous | `94-interview-questions-a.md` |
| Next | `94-interview-questions-c.md` |
...
```
path: 94-interview-questions-b.md
lines: <wc -l of the file you wrote>
leaves: 5.1.33–5.1.64
