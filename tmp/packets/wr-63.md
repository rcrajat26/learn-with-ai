# Writer packet — `91-interview-intermediate.md`
...
```
/Users/rajat.chikkodikar/Desktop/My-files/rough/src/notes/detailed/04-modern-java/91-interview-intermediate.md
```
...
| Field | Value |
|---|---|
| File | `91-interview-intermediate.md` |
| Subject | 91 interview intermediate.md |
| Part / tier | Part 2 — INTERVIEW |
| Syllabus sections | §2.1, §2.15 — The master tables, Which construct |
| Leaves | — (0 leaves) |
| Primary concepts | Part 2 wrap-up: the summary table over the whole intermediate tier, 10 spoken-length Q&As, 5 predict-the-output puzzles |
| Diagrams | — |
| Examples (QuizStakes slice) | Puzzles drawn from the parallel-stream, collector and virtual-thread examples used across Part 2 |
| Previous | `90-interview-basics.md` |
| Next | `92-interview-internals.md` |
...
```
path: 91-interview-intermediate.md
