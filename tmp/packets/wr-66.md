# Writer packet — `94-interview-questions-a.md`
...
```
/Users/rajat.chikkodikar/Desktop/My-files/rough/src/notes/detailed/04-modern-java/94-interview-questions-a.md
```
...
| Field | Value |
|---|---|
| File | `94-interview-questions-a.md` |
| Subject | 94 interview questions a.md |
| Part / tier | Part 5 — INTERVIEW |
| Syllabus sections | §5.1 — The questions, with the answer shape |
| Leaves | 5.1.1–5.1.32 (32 leaves) |
| Primary concepts | questions 5.1.1–5.1.32 with the full answer shape: functional interfaces, lambdas, method references, the stream model, laziness and the intermediate operations |
| Diagrams | — |
| Examples (QuizStakes slice) | Every answer grounded in the ledger, reservation and deposit examples the earlier files built |
| Previous | `93-interview-build-it.md` |
| Next | `94-interview-questions-b.md` |
| Target size | **1008 lines**, and anything from 705 to 1360 is fine |
...
These are the **32 syllabus leaves you own**, verbatim, in order. Every one must appear in the file, or be listed in `## Deferred` with a one-line reason. No other file covers them; no other file's leaves are yours.
...
```
path: 94-interview-questions-a.md
