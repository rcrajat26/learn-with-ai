# Writer packet — `build-it/04-records-sealed-patterns.md`
...
```
/Users/rajat.chikkodikar/Desktop/My-files/rough/src/notes/detailed/04-modern-java/build-it/04-records-sealed-patterns.md
```
...
| Field | Value |
|---|---|
| File | `build-it/04-records-sealed-patterns.md` |
| Subject | build it |
| Part / tier | Part 4 — BUILD IT |
| Syllabus sections | §4.5 — Records, sealed types and patterns from scratch |
| Leaves | 4.5.1–4.5.8 (8 leaves) |
...
| Diagrams | — |
| Examples (QuizStakes slice) | `StakeSplit` hand-written against the one-line record; `PaymentRun`'s `List<WithdrawalTransaction>` and `byte[] signature` |
| Previous | `build-it/03-collectors-and-myoptional.md` |
| Next | `build-it/05-concurrency-builds.md` |
...
```
path: build-it/04-records-sealed-patterns.md
