# Writer packet — `platform-and-releases/02-migration.md`
...
```
/Users/rajat.chikkodikar/Desktop/My-files/rough/src/notes/detailed/04-modern-java/platform-and-releases/02-migration.md
```
...
| Field | Value |
|---|---|
| File | `platform-and-releases/02-migration.md` |
| Subject | platform and releases |
| Part / tier | Part 2 — INTERMEDIATE |
| Syllabus sections | §2.14 — Migration, 8 → 21 |
| Leaves | 2.14.1–2.14.14 (14 leaves) |
| Primary concepts | what breaks at 9/11/16/17/18/21; JEP 400 UTF-8 as the silent behaviour change; the library floor; the mechanical refactors worth doing; the safe rollout order |
| Diagrams | D-122, D-123 |
| Examples (QuizStakes slice) | Migrating `FundsLedger` and `DocumentVerification` from 8 to 21: `String.getBytes()` on a payout file at 18, and `getFirst()` clashing on a hand-rolled sequenced type at 21 |
| Previous | `platform-and-releases/01-basics.md` |
| Next | `platform-and-releases/03-internals-version-delta.md` |
...
```
path: platform-and-releases/02-migration.md
lines: <wc -l of the file you wrote>
leaves: 2.14.1–2.14.14
